...
public static class RunProgress
{
    ...
    public static void MarkRunStarted() => RunStarted = true;
    ...
    public static void SetForgeLevels(int weaponLevel, int armorLevel)
    {
    ...
    private static void ClearOnFreshPlay() => Reset();
}
